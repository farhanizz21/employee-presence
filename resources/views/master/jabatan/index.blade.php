                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end">
                                        <a href="{{ route('jabatan.create')}}" class="btn btn-primary shadow-sm"> <i
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('jabatan.index') }}"
                                    ...
                                    <div class="col-auto">
                                        <button type="submit" class="btn btn-primary"> <i class="fas fa-search"></i> Cari
                                        </button>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('jabatan.index') }}" class="btn btn-warning"> <i
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        $currentOrder = request('sort_order') == 'asc' ? 'desc' : 'asc'; @endphp
                                        <thead>
                                            <tr>
                                                <th rowspan="2" style="width: 2%;">#</th>
                                                <th rowspan="2"> <a
                                                        href="{{ route('jabatan.index', ['sort_by' => 'jabatan', 'sort_order' => $currentOrder] + request()->all()) }}"
                                                        class="text-light fw-bold"> Jabatan
                                                        @if(request('sort_by') == 'jabatan' && request('sort_order') == 'asc')
                                                            <i class="fas fa-sort-up"></i>
                                                        @elseif(request('sort_by') == 'jabatan' && request('sort_order') == 'desc')
                                                        <i class="fas fa-sort-down"></i> @else <i class="fas fa-sort"></i>
                                                        @endif </a> </th>
                                                <th rowspan="2" style="width: 10%;">
                                                    <form method="GET" action="{{ route('jabatan.index') }}"> <select
                                                            name="filter_sistem" class="form-select form-select-sm"
                                                            onchange="this.form.submit()">
                                                            <option value="">Semua Sistem Gaji</option>
                                                            <option value="1" {{ request('filter_sistem') == '1' ? 'selected' : '' }}> Harian </option>
                                                            <option value="2" {{ request('filter_sistem') == '2' ? 'selected' : '' }}> Borongan </option>
                                                        </select> </form>
                                                </th>
                                                <th colspan="3" style="text-align:center; vertical-align:middle;">Gaji</th>
                                        ...
                                        <tbody> @forelse($jabatans as $jabatan) <tr class="align-middle">
                                            <td>{{ $loop->iteration }}</td>
                                            <td class="text-truncate">{{ $jabatan->jabatan }} </td>
                                            <td class="text-truncate"> {{ $jabatan->harian_text }} </td>
                                           ...
                                           <td class="text-truncate"
                                            ...
                                            <i class="fas fa-coins text-white"></i> </a> @else <a
                                                        href="{{ route('jabatan.edit', $jabatan->uuid) }}"
                                                        class="btn btn-sm btn-warning" data-bs-toggle="tooltip"
                                                    title="Edit"> <i class="fas fa-edit text-white"></i> </a> @endif
                                                ...
                                                class="fas fa-trash"></i> </button> </form> @endif
                                            </td>
                                        </tr> @empty <tr>
                            ...
                            <div class="card-footer clearfix">
                                <div class="float-end"> {{ $jabatans->withQueryString()->links('pagination::bootstrap-4') }}
                                </div>
                            </div>
                        </div>
                        <!-- /.card -->
